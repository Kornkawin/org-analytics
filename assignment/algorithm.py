...
if __name__ == '__main__':
    # A-F is the project name
    # #1-#4 is the developer id
    # The value is the time taken by the developer to complete the project
    # Must be NxN matrix
    H = {
        'A': { '#1': 22, '#2': 14, '#3': 120, '#4': 21 },
        'B': { '#1': 19, '#2': 12, '#3': 172, '#4': 21 },
        'C': { '#1': 161, '#2': 122, '#3': 2, '#4': 50 },
